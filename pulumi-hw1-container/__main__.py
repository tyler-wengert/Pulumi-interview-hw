...
msg = config.require('msg') #Add (and require) a config value for this new configurable message 
        ...
        containers=[
            containerinstance.ContainerArgs(
                ...
                environment_variables=[
                    ...
                    #Add in my custom environment variable to pass config value into app environment
                    containerinstance.EnvironmentVariableArgs( 
                        name="MESSAGE",
                        value=msg,
                    ),
...
pulumi.export("Configured message", msg)
